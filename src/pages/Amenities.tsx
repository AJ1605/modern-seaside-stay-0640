...
import { Flower2, Dumbbell, Droplets, Heart, Utensils, Wine, Coffee, Clock, Car, Plane, Car as CarIcon, MapPin, Waves, Users, Music, BookOpen } from "lucide-react";
...
export default function Amenities() {
  ...
  const getIcon = (categoryName: string, index: number) => {
    const icons = {
      wellness: [<Flower2 key={0} />, <Dumbbell key={1} />, <Droplets key={2} />, <Heart key={3} />],
